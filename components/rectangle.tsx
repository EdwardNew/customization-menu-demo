...
export function Rectangle({
    ...
    const primaryColorParsed = parseColor(primaryColor);
    ...
    const primaryColorDarkAccent = primaryColorParsed
        .withChannelValue(
            "lightness",
            Math.max(primaryColorParsed.getChannelValue("lightness") - 5, 0)
        )
        .toString("hsl");
    return (
        <div
            className="max-w-[360px] border-solid box-content"
            style={{
                backgroundColor: primaryColor,
                borderColor: primaryColorDarkAccent,
        ...
        >
            <div
                className="relative flex w-[360px] h-[480px] flex-col items-center justify-between rounded-[4rem] bg-transparent p-[48px] transition-transform duration-[0.6s] ease-in-out"
            ...
            >
                ...
                <div className="flex flex-col gap-3 lg:text-lg">
                    ...
                    <button
                        className="mobile-button rounded-full p-2 transition-transform duration-[0.6s] ease-in-out"
                        style={{
                            color: accentColor,
                    ...
                    <div className="mobile-apply transition-transform relative duration-[0.6s] ease-in-out rounded-full p-2">
                        <div
                        ...
                        ></div>
                        <p
                            className="mobile-apply-text transition-transform duration-[0.6s] ease-in-out z-[1] relative mx-auto w-fit"
